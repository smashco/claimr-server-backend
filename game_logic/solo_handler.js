...
async function handleSoloClaim(io, socket, player, players, trail, baseClaim, client) {
    ...
    console.log(`[DEBUG] Starting solo claim for ${player.name} (${userId}) | InitialClaim: ${isInitialBaseClaim} | Power: ${player.activePower}`);
    ...
    if (isInitialBaseClaim) {
        ...
        // Block base claims inside territory unless INFILTRATOR
        ...
        if (intersectionResult.rowCount > 0 && !isInfiltrator) {
